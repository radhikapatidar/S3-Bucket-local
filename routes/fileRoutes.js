...
const {  uploadFile, getFileUrl ,getFileStream,streamFile} = require('../controllers/fileController');
...
router.get('/file/:filename', authenticate, getFileUrl,streamFile); // Get signed download URL
